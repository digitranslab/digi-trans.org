/**
 * WebinarsPage Component
 * 
 * Shows both Webinars and Tech Talks content merged into one page.
 * Requirements: 13.1
 */
...
const WebinarsPage = () => {
  ...
  // Merge tech-talks and webinars content
  const allContent = contentItems.filter(
    (item) => item.category === "webinars" || item.category === "tech-talks"
  );
        ...
        <section className="relative pt-36 pb-24 overflow-hidden">
          ...
          <div className="relative container mx-auto px-4">
            <AnimatedWrapper animation="fade-up-slow" className="max-w-4xl mx-auto text-center">
              ...
              <TypewriterGradientText text="Webinars & Tech Talks" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" duration={1.8} />
              <p className="text-xl text-gray-300/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                Live sessions, tech talks, community meetups, and workshops on AI, security automation, and data engineering.
              </p>
          ...
          <div className="container mx-auto px-4">
            <AnimatedWrapper animation="fade-up" delay={0.1}>
              <div className="max-w-xl mb-12 relative">
                ...
                <input
                  type="text"
                  placeholder="Search webinars and tech talks..."
                  value={searchQuery}
