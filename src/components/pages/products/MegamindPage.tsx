          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedWrapper animation="fade-up-slow" className="max-w-4xl mx-auto text-center">
              <div className="flex justify-center mb-6">
                <MegamindLogo size={72} className="text-purple-400" />
              </div>
                ...
                <AnimatedWrapper key={cap.id} animation={i % 2 === 0 ? "slide-right" : "slide-left"}>
                  <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 items-center`}>
                    <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                      ...
                      <p className="text-sm text-purple-400/80 italic border-l-2 border-purple-500/30 pl-4">"{cap.marketingAngle}"</p>
                    </div>
                        ...
                        <div className="relative bg-gray-900/70 backdrop-blur-sm border border-gray-800/50 rounded-3xl p-8 min-h-[280px] flex items-center justify-center">
                          <div className="text-center">
                            <div className="inline-flex p-5 rounded-2xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 mb-4">
                              {getIcon(cap.icon, "w-10 h-10 text-purple-400")}
                            </div>
                            <p className="text-lg font-semibold text-white mb-2">{cap.title}</p>
                            <p className="text-sm text-gray-500">{cap.capabilities.length} capabilities</p>
                          </div>
                        </div>
                      </div>
                    </div>
