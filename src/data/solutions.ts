...
export const solutionsData: Record<string, SolutionData> = {
  "retail": {
    ...
    caseStudies: [
      ...
      {
        title: "AI-Powered Supply Chain Optimisation",
        description: "Implemented predictive inventory management and supply chain analytics for a global retailer with 200+ locations.",
        results: ["30% reduction in operational costs", "99.8% inventory accuracy", "25% faster order fulfilment"],
      },
    ],
  ...
  "manufacturing": {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        description: "Deployed end-to-end Industrial AI platform connecting OT and IT systems for a global manufacturer.",
